...
- Tool runtime: local tool generation, execution, governance, reliability tracking, generated-tool SQL registry auto-registration, registry duplicate preflight checks, deprecated registry exclusion, permission conflict fail-closed checks, output/log redaction for tool execution, usage tracking, and registry routes exist; bound tool approval records, stronger OS/process sandbox isolation, richer permission enforcement, and production-safe dependency isolation remain.
