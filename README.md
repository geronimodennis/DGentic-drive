...
- Tool runtime: local tool generation, execution, governance, reliability tracking, generated-tool SQL registry auto-registration, registry duplicate preflight checks, deprecated registry exclusion, permission conflict fail-closed checks, usage tracking, and registry routes exist; bound tool approval records, stronger OS/process sandbox isolation, richer permission enforcement, output redaction, and production-safe dependency isolation remain.
