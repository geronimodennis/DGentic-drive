...
Status: backend MVP sprint surface active; Sprint 15 production identity, secrets, and network guardrails is in progress, with BL-009a through BL-009y implemented.
...
- DGentic-native plugin bundles beyond manifest discovery/trust, plugin-backed recipe installation/loading, richer managed settings policy-source controls, and guarded git/PR workflow automation: planned across remaining Sprint 15 security follow-ups plus Sprint 16 UI, Sprint 17 CLI/VS Code, and Sprint 18 CI/observability work after the Claude Code repository study.
