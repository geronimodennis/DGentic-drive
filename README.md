...
- Restart adoption/resume for detached orchestration workers, production multi-agent scheduling leases, and end-to-end autonomous sprint execution inside the backend runtime: remaining Sprint 14 work.
