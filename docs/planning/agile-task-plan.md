...
- Not yet implemented: full unified chat beyond local task history, actual AI-change file apply/revert workflow beyond saved review artifacts, broader editable settings/policy UX, VS Code extension, and dedicated CLI client.
