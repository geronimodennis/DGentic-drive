...
- Not yet implemented: deeper full chat UX beyond the first task-chat composer, persistent AI-change artifact apply/revert workflow beyond session review annotations, full non-CLI request editors/execution, broader editable settings/policy UX, VS Code extension, and dedicated CLI client.
