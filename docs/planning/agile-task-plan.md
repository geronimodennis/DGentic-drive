...
- Not yet implemented: deeper full chat UX beyond the first task-chat composer, AI-change accept/reject artifact workflow beyond raw Git diff visibility, full non-CLI request editors/execution, broader editable settings/policy UX, VS Code extension, and dedicated CLI client.
