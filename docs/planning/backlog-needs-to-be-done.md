...
- Remaining: full unified chat beyond local task history, actual AI-change file apply/revert mutation workflows beyond saved review artifacts, deeper nested type-specific non-CLI editors, broader editable policy/settings surfaces for providers, routing, filesystem, CLI policy lifecycle, memory, tools, command recipes, plugins, hook policies, and persistent/multi-worker project activation semantics.
...
- Remaining: deepen the UI into full unified chat beyond local task history, actual AI-change file apply/revert mutation workflows beyond saved review artifacts, broader editable policy/settings surfaces, deeper nested type-specific non-CLI editors, and persistent/multi-worker project activation semantics.
