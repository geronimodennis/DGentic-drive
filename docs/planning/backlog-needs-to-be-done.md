...
- BL-010aq adds a unified task-chat context stream that summarizes active project/root, task plans, task runs, pending approvals, and recent logs, then lets users insert compact context cards into the chat context composer without duplicating approval execution authority.
...
- Remaining: deeper full-chat execution semantics beyond the context stream, actual AI-change file apply/revert mutation workflows beyond saved review artifacts, broader editable policy/settings surfaces for providers, routing, filesystem, richer CLI policy lifecycle, memory lifecycle/compression apply actions beyond preview/detail surfaces, deeper tools/plugins workflows beyond governance and trust, and persistent/multi-worker project activation semantics.
...
- Remaining: deepen the UI into full-chat execution semantics beyond the context stream, actual AI-change file apply/revert mutation workflows beyond saved review artifacts, broader editable policy/settings surfaces beyond CLI policy, hook policy, command recipes, plugin trust, and generated-tool governance, memory lifecycle/compression apply actions beyond preview/detail surfaces, and persistent/multi-worker project activation semantics.
