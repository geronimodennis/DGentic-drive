...
- Activity/session workbench: BL-010cc, Sprint 16. Implemented session summary capture/list/use-context controls through `/sessions/summary`, session event filtering through `/logs`, and bounded session-summary context cards in Task Chat.
