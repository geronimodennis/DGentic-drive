...
- Remaining: fine-grained shared-memory ACLs/policies beyond current owner/provenance/tag scoping, detached worker restart adoption/resume, and production multi-agent scheduling/lease semantics.
