...
- Task Chat provider route preview: BL-010cb, Sprint 16. Implemented Task Chat route preview cards through `/routing/decide`, with Use Route provider/model application and Use Context insertion while leaving generation and approval execution behind existing guarded controls.
