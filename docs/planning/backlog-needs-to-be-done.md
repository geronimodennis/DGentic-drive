...
- Remaining: full unified chat beyond local task history, persistent AI-change artifact apply/revert workflows beyond session review annotations, deeper nested type-specific non-CLI editors and provider/tool network-approval consuming flows, broader editable policy/settings surfaces for providers, routing, filesystem, CLI policy lifecycle, memory, tools, command recipes, plugins, hook policies, and the remaining generated-tool browser-driven seeded approval scenario.
...
- Remaining: deepen the UI into full unified chat beyond local task history, persistent AI-change artifact apply/revert workflows, broader editable policy/settings surfaces, deeper nested type-specific non-CLI editors, persistent/multi-worker project activation semantics, and the remaining generated-tool browser-driven seeded approval scenario.
