...
- Git diff review ergonomics: BL-010bo, Sprint 16. Implemented decision filters, bulk visible accept/reject/clear actions, and per-section patch copy for checkpoint-bound raw diff reviews without adding backend hunk apply/revert authority.
