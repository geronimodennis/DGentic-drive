...
- Remaining: deepen the UI into full unified chat beyond local task history, persistent AI-change artifact apply/revert workflows, broader editable policy/settings surfaces, deeper nested type-specific non-CLI editors, and persistent/multi-worker project activation semantics.
