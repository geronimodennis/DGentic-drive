...
- Remaining: full unified chat beyond local task history, actual AI-change file apply/revert mutation workflows beyond saved review artifacts, broader editable policy/settings surfaces for providers, routing, filesystem, richer CLI policy lifecycle, memory, tools, command recipes, plugins, and persistent/multi-worker project activation semantics.
...
- Remaining: deepen the UI into full unified chat beyond local task history, actual AI-change file apply/revert mutation workflows beyond saved review artifacts, broader editable policy/settings surfaces beyond CLI and hook policy, and persistent/multi-worker project activation semantics.
