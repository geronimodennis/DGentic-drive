...
- Remaining: deepen the UI into full chat workflows beyond the task-plan cards, accept/reject AI-change artifact workflows, broader editable policy/settings surfaces, broader non-CLI execution UX, persistent/multi-worker project activation semantics, end-to-end approval scenario coverage, and broader browser/responsive validation.
